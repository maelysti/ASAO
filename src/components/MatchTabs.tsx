...
import { ChevronLeft, ChevronRight, Hash, Search, Clock } from "lucide-react";
  ...
  return (
    <div className="bg-slate-900 border-b border-slate-800 px-4 lg:px-8 py-3">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
        {/* Round Page Controls (Précédent / Round Indicator / Suivant) */}
        <div className="flex items-center gap-2 bg-slate-950/90 border border-slate-800 p-1.5 rounded-2xl w-full lg:w-auto justify-between lg:justify-start shadow-md">
          {/* Button: Précédent */}
          <button
            onClick={onPrevRound}
            disabled={totalRounds === 0}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700/80 hover:border-emerald-500/50 transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
          ...
          <button
            onClick={onNextRound}
            disabled={totalRounds === 0}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/30 transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
