...
export default function App() {
  ...
  const activeRoundMatches: CombinedMatchData[] = rawMatchesForActiveRound.map((m: any) => {
    ...
    return {
      ...
      state: (isFinished || m.state === "Ended" || m.state === "Undisputed" || m.state === "Finished") ? "Finished" : (m.state || "PreEvent"),
      preEventOrLive: (isFinished || m.preEventOrLive === "Ended" || m.preEventOrLive === "Finished") ? "Finished" : (m.preEventOrLive || "PreEvent"),
